const editorTemplate = '<button id="addProduct" class="button">Add SpeakerB</button>';
...
const toolEmailTemplate = function (values, isViewer = false) {
  ...
  return `
    <table speakerId="${values.speakerImage.url}" cellspacing="0" cellpadding="0" style="position:relative;min-width:0;word-wrap:break-word;background-color:#fff;background-clip:border-box;border:1px solid rgba(0,0,0,.125);border-radius:4px;margin:auto;text-align:center;">
      <tbody>
        ...
        <tr><td width="100%"><div class="description" style="text-align: left;padding: 0 16px; margin: 0 0 12px 0">${values.speakerDescription}</div></td></tr>
        <tr><td width="100%"><h4 style="text-align: left;margin: 8px 0 12px 0; padding: 0 16px; color: ${values.speakerEmailColor};">${values.speakerEmail}</h4></td></tr>
      </tbody>
    </table>
  `;
};
