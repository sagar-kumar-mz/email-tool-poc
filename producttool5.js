...
const toolEmailTemplate = function (values, isViewer = false) {
  ...
  return `
    <table speakerId="${
      ...
      <tbody>
        <tr><td width="100%"><img id="speakerImage" src="${
          values.speakerImage.url
        }" style="width: 100%; object-fit: contain; border-top-left-radius: 4px; border-top-right-radius: 4px;" /></td></tr>
        <tr><td width="100%"><h3 id="speakerTitle" style="text-align: left;margin: 8px 0 12px 0; padding: 0 16px; color: ${
          values.speakerTitleColor
        };">{{values.speakerTitle}}</h3></td></tr>
        <tr><td width="100%"><div id="speakerAbout" class="description" style="text-align: left;padding: 0 16px; margin: 0 0 12px 0">${
          values.speakerAbout
        }</div></td></tr>
        <tr><td width="100%"><h4 id="speakerEmail" style="text-align: left;margin: 8px 0 12px 0; padding: 0 16px; color: ${
